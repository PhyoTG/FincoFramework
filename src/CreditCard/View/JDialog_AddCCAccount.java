...
public class JDialog_AddCCAccount extends javax.swing.JDialog
{
    ...
    public IFincoController creditController = new CreditCardController();
	...
	{  
	   String accNo = JTextField_CCNR.getText();
		...
		String mail = JTextField_ExpDate.getText();
		...
		creditController.addCreditAccount(accNo,name,street,city,state,zip,mail,null,accountType);
        dispose();
	}
