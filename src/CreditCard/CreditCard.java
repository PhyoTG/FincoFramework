...
import CreditCard.View.CreditCardController;
import CreditCard.View.JDialogGenBill;
import CreditCard.View.JDialog_AddCCAccount;
import CreditCard.View.JDialog_CCDeposit;
import CreditCard.View.JDialog_CCWithdraw;
...
public class CreditCard extends javax.swing.JFrame
{
    ...
    public CreditCard thisframe;
    private Object rowdata[];
    public static IFincoController viewController = new CreditCardController();
    ...
    static public void main(String args[])
	{
		try {
			...
			(new CreditCard("Credit Card")).setVisible(true);
		} 
		catch (Throwable t) {
			t.printStackTrace();
...
//        rowdata = new Object[8];
	...
	void JButtonNewCCAC_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		*/
		...
		refreshTable(viewController.getAccounts());
	...
	public void refreshTable(Collection<Account> aa) {
		...
		for (Account account : accounts) {
			...
			row[3] = account.getAccType();

			row[4] = account.getCurrentAmount();
	...
	void JButtonDeposit_actionPerformed(java.awt.event.ActionEvent event)
	{
        ...
        if (selection >=0){
		    ...
		    JDialog_CCDeposit dep = new JDialog_CCDeposit(thisframe,name,name);
...
//		    model.setValueAt(String.valueOf(newamount),selection, 4);
	...
	void JButtonWithdraw_actionPerformed(java.awt.event.ActionEvent event)
	{
        ...
        if (selection >=0){
		    ...
		    JDialog_CCWithdraw wd = new JDialog_CCWithdraw(thisframe,name,name);
