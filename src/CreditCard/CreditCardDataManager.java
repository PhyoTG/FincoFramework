...
public class CreditCardDataManager extends DataManager{
    ...
    public void loadData() {
    	JSONObject jsonObject = this.db.read("./credit-data.json");
	...
	public void writeData() {
		...
		this.db.write("./credit-data.json", jsonObject);
	}
}
