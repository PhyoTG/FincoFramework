...
public class BankJDialog_AddCompAcc extends JDialog
{
	 ...
	 private FincoController bankController = new BankViewController();
		...
		public BankJDialog_AddCompAcc(FincoFramework parent)
		{
			super(parent);
			parentframe=parent;
	...
	{
		System.out.println("From App Level AL/AP");
		...
		if (JRadioButton_Chk.isSelected())
         accountType="Ch";
		bankController.addCompanyAccount(accNo,name,street,city,state,zip,mail,empNum,accountType);
	   dispose();
